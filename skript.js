...
console.log("Může být předmět darovaný: " + data.data.entries[0].giftable);


//vytáhni z jsonu obrázek bundlu
console.log("Obrázek bundlu: " + data.data.entries[0].bundle.image);


//vytáhni z jsonu název bundlu 
console.log("Název bundlu: " + data.data.entries[0].bundle.name);

//vytáhni slevu
console.log("Sleva: " + (data.data.entries[0].regularPrice - data.data.entries[0].finalPrice));

//vytáhni normální cenu
console.log("Cena po slevě: " + data.data.entries[0].regularPrice);

//vytáhni cenu po slevě
console.log("Cena po slevě: " + data.data.entries[0].finalPrice);
